...
\ifxetexorluatex % If you're using XeLaTeX or LuaLaTeX
  ...
  \usepackage[p,lf,swashQ]{cochineal}
...
\leftheader{%
  ...
  \vspace{0.6em}
  \small I am an undergraduate student in Biological Sciences at ShanghaiTech University, currently on exchange at UC Berkeley. My interests span biochemistry, molecular biology, and the intersection of biology with computational tools.

  \vspace{0.8em}
  \begin{tabular}{@{}ll@{}}
    \makefield{\faEnvelope[regular]}{\href{mailto:wxiangyu31@outlook.com}{\texttt{wxiangyu31@outlook.com}}} &
    ...
    \makefield{\faGlobe}{\href{https://xiangyuw1.github.io/}{\texttt{xiangyuw1.github.io}}}
  \end{tabular}
}
